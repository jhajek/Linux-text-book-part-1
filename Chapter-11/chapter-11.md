...
LVM is a sperate component from traditional filesystems and was seen as a stop gap method until newer filesystems could be created that would effectively do the same thing as LVM + Ext4. Filesystems like XFS, btrfs, or ZFS have been developed and integrated to the Linux Kernel.
