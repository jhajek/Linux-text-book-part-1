...
### SysVinit
  ...
  Here is where the boot process begins to splinter.  I am going to describe the Unix System V init process - that was the basis of all Unix and Linux knowledge since the early 1980s.  This is referred to as SysVinit--note that only the Unix based derivatives of BSD use this--Debian recently dropped it, with Fedora and Ubuntu abandoning circa 2015.
