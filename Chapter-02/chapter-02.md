...
[Hello World in x86 Inter Assembly for Linuix](http://en.literateprograms.org/Hello_World_%28Assembly_Intel_x86_Linux%29 "x86 Linux Intel Assembly")
...
[C Language equivilant of above code](https://en.wikipedia.org/wiki/List_of_Hello_world_program_examples#C "C Hello World")
...
__Andrew Tanenbaum and Minix__
  ...
  Before we talk about the Linux kernel, we need to talk about the Minix operating system.  With the closing off of the AT&T Unix source code by 1984 to academics and researchers in the university - they were left without source to show as examples in his classes.  
...
![*Eric S. Raymomd*](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Eric_S_Raymond_portrait.jpg/256px-Eric_S_Raymond_portrait.jpg "Eric S. Raymond")
