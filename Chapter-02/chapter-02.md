...
The term opensource software is prevasive today but in 1998. it didn't exist.  The term *free software* had existed since 1985, but because of the ambiguity of the English word *free* it became associated with zero-cost free.  This also gives the potential idea of cheap or shoddy work--compared to professional propriatery work and the enterprise would not touch it.  

The term opensource was not a movement away from the principles of *free software* but a chance to show the enterprise that the opensource development model was sustainable and could produce superioir sustainable products.  This movement was started by Eric S. Raymond and Bruce Perens.  In order to better understand this difference we need to meet some of the key players. Enter Eric S. Raymond.
