...
Red hat's founder Mark Ewing had been an IBM employee prior to forming Red hat.  He knew something about enterprise software and more importantly enterprise profits.  Red hat began it's life as a desktop Linux company.  They quickly to shift their focus to compete not with Windows and Apple, but to take on the enterprise giants of IBM, HP, Sun and AT&T.  These companies had one thing in common: they were all Unix vendors.  Red hat's vector was to dislodge the estapblished Unix vendors with Red Hat Enterprise Linux (RHEL). They would succesfully attack this market with entirely opensource products and runnning on commdity Intel x86 based processors.  With Oracle also sensing a chance to capture market share along with RHEL, it announced it would port its products to RHEL and this platform became to the go to choice as the alternative against Microsoft and Unix vendors, putting Sun and Solaris basically out of business.  
