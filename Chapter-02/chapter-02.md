...
### Free Software Foundation and the GPL
 ...
 > “Our mission is to preserve, protect and promote the freedom to use, study, copy, modify, and redistribute computer software, and to defend the rights of Free Software users.”
  ...
  By 1989 a new role for the FSF arose. Commercial entities were starting to take notice of GNU produced free software and corrupt the idea of *free* software by using the code and not givign proper attirbution or access to the course. The FSF needed a way to protect their software freedoms.  But how?  Copyright was restrictive and would make the FSF no different from the commercial entities that place restrictions on code freedom.  Public Domain offered no legally enforceable protections.   So enter __copyleft__ which is a hack on the term copyright in the form of the [GPL - GNU General Public License.](https://en.wikipedia.org/wiki/GNU_General_Public_License "GPL")  It flips copyright over by basically requiring you to freely distribute the source code of any project licensed under the GPL. You need to attribute where your source came from, and that you cannot restrict any of these rights to any future derivative work.  Meaning that you cannot "close source" some opensource code that is licensened under the GPL.  Sometimes people will say that a work licensended under the GPL is __GPLed__.  

#### GCC and GNU HURD

  In 1984 RMS started his work of creating a free Unix-like operating system.  Since Unix was built upon the C programming language, the first thing needed to build a kernel, a shell, or tooling was a C compiler.  This project was called GCC or GNU C Compiler which was a *"free"* version of the proprietary Unix AT&T "cc" program or C compiler.  Next Stallman needed a text or screen editor to edit files and run his compiler tools to build software. A few yearsa proro, in 1981, James Gosling had created the Gosling Emacs editor, [gmacs](https://en.wikipedia.org/wiki/Gosling_Emacs "Gosling Stallman and Emacs"), which in a few words is a text editor used for modifying text files.  We will learn more about editors in chapter 7. This name should be familiar because James Gosling would later go on to create the Java programming language while at Sun in 1994.  Stallman almost single-handedly rewrote all of Gosling's code to produce a *"free"* version of gmacs called __emacs__.  This program is over 30 years old and still in use. The GNU project now started to reverse engineer all the basic Unix tools needed to accomplish tasks: such as [ls, grep, awk, mv, make and cp.](https://en.wikipedia.org/wiki/GNU_Project "Commands")   Eventually an entire "zoo" of projects were created and are available at [GNU's website](https://www.gnu.org "GNU Website"). [Other GNU tools](http://www.gnu.org/manual/blurbs.html) were added by contributors and volunteers over the years.  The GNU project did remarkably well in quiality and quantity of *free* programs considering there were most;ly volunteers with little funding and no corporate backing. They had pretty much reverse engineered, and in some cases improved, all the components of Unix by 1991 (8 years of work). The the project was missing one critical piece...  they didn't have a kernel for their operating system.  Turns out that writing a kernel is much harder than it looks.  
