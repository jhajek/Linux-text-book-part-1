...
By the end of the 90s a curious thing was happening; Microsoft had a near total domination of the desktop PC operating system market and was being investigated by the US Department of Justice for anti-competetive practices, Apple had just brought Steve Jobs back as CEO and was beginning to take steps towards recovering from a decade of mediocre performance.  and the internet as a public tool was beginning to take root.  At the same time, the quality of free and opensource software was increasing.  The internet was powered by webservers and databases.  Opensource tools such as Apache Webserver and MySQL database beame the *killer apps* to use on Linux or BSD to power the internet.

By 1998 a growing portion of the Free Software Movement, which was led by the FSF and championed by Richard Stallman, began to see an opportunity.  The term *free software* had a moral flaw it perceived and was trying to correct as its primary purpose.  But the quality of the software compared to the propriatery competetion was lacking. The term *"Free"* software has an ambiguous meaning in English.  The mind first starts to thing about free-as in price-free.  This also gives the idea of cheap or shoddy work--compared to professionals and the enterprise would not touch it.  

Many commercial entities were simply not interested or afraid because they were concerned about losing the chance to make money or retain rights over programs they created.  Developers saw a chance to promote the quality and community of *free software* to the larger commercial market.  This was the time to strike. This group did not hold with the FSF's absolute moral stance on *free software* as the ultimate argument in free software adoption. Instead they compared open or public development and open access to code as superior in quality and a cost reduction to closed source development.  Hence the name, *opensource*.  Now in Fall of 1998, we have the birth of the opensource movement alongside the *Free software* movement.  In order to better understand this difference we need to meet some of the key players. Enter Eric S. Raymond.
