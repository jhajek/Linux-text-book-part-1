...
source "virtualbox-iso" "alma-linux-9-vanilla" {
  ...
  http_port_min           = 9001
  http_port_max           = 9100
  iso_checksum            = "file:http://almalinux.interhost.co.il/9.2/isos/x86_64/CHECKSUM"
  iso_urls                = ["http://almalinux.interhost.co.il/9.2/isos/x86_64/AlmaLinux-9.2-x86_64-boot.iso"]
