...
If (Test-Path "./output/test-pdf-docx/Understanding-Free-and-Opensource-Operating-Systems-Part-I*"){
...
#############################################################################################################################
<# pandoc --toc --number-sections -o ./output/test-pdf-docx/Understanding-Free-and-Opensource-Operating-Systems-Part-I-$STAMP.docx -f markdown -t docx ./title/title.txt  ./Chapter-01/chapter-01.md ./Chapter-02/chapter-02.md ./Chapter-03/chapter-03.md ./Chapter-04/chapter-04.md ./Chapter-05/chapter-05.md ./Appendix-A/Appendix-A.md
#>
#############################################################################################################################
# ODT
#############################################################################################################################
<# pandoc --toc --number-sections -o ./output/test-pdf-docx/Understanding-Free-and-Opensource-Operating-Systems-Part-I-$STAMP.odt -f markdown ./title/titlesec.tex  ./Chapter-01/chapter-01.md ./Chapter-02/chapter-02.md ./Chapter-03/chapter-03.md ./Chapter-04/chapter-04.md ./Chapter-05/chapter-05.md ./Appendix-A/Appendix-A.md
#>
#################################################################
# EPUB - To convert it to EPUB, use this command:               #
#################################################################
<# pandoc --toc --number-sections --epub-cover-image=images/Chapter-Header/Cover/John_Calvin_by_Holbein.png -S -o ./output/test-pdf-docx/Understanding-Free-and-Opensource-Operating-Systems-Part-I-$STAMP.epub ./Chapter-01/chapter-01.md ./Chapter-02/chapter-02.md ./Chapter-03/chapter-03.md ./Chapter-04/chapter-04.md ./Chapter-05/chapter-05.md ./Appendix-A/Appendix-A.md 
#>
######################
# Debugging          #
######################
#cp -Force C:\Users\palad\Documents\Linux-text-book-part-1\output\test-pdf-docx\Understanding-Free-and-Opensource-Operating-Systems-Part-I-$STAMP.pdf  C:\Users\palad\OneDrive\Documents\epub
#cp -Force C:\Users\palad\Documents\Linux-text-book-part-1\output\test-pdf-docx\Understanding-Free-and-Opensource-Operating-Systems-Part-I-$STAMP.docx C:\Users\palad\OneDrive\Documents\epub
#cp -Force C:\Users\palad\Documents\Linux-text-book-part-1\output\test-pdf-docx\Understanding-Free-and-Opensource-Operating-Systems-Part-I-$STAMP.odt C:\Users\palad\OneDrive\Documents\epub
###########################################
