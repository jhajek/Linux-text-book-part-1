...
If (Test-Path ./output/test-pdf-docx/Understanding-the-Technology-and-Philosophy-of-Linux-Part-I*){
  rm -v ./output/test-pdf-docx/*.pdf
  rm -v ./output/test-pdf-docx/*.docx
}Else{
...
########################################################################################################################
pandoc --toc -V geometry:margin=1in --number-sections --include-in-header ./title/titlesec.tex -s -o ./output/test-pdf-docx/Understanding-the-Technology-and-Philosophy-of-Linux-Part-I-$STAMP.pdf ./Chapter-01/chapter-01.md ./Chapter-02/chapter-02.md ./Chapter-03/chapter-03.md  
