...
1) Using the file on Ubuntu: `/var/log/syslog` or Fedora `/var/log/dnf5.log`:  Type the command to display the last 10 lines of this file
1) Using the file on Ubuntu: `/var/log/syslog` or Fedora `/var/log/dnf5.log`:  Type the command to display the first 10 lines of this file
1) Using the file on Ubuntu: `/var/log/syslog` or Fedora `/var/log/dnf5.log`:  Using the `man` command on the previous question, find how to display the last 25 lines of this file
1) Using the file on Ubuntu: `/var/log/syslog` or Fedora `/var/log/dnf5.log`:  Type the command to display the entire contents of this file backwards (last line to first)
1) Using the file on Ubuntu: `/var/log/syslog` or Fedora `/var/log/dnf5.log`:  Use one of the commands to allow for paging through one of these commands (hit 'q' to quit the paging command)
