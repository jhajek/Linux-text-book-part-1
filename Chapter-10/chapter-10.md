...
1) On Fedora what is the command to add the RPMFusion packages for Free and Non-Free?  Execute those commands and install and run the VLC media player.  Located here: [http://download1.rpmfusion.org/free/fedora/releases/26/Everything/x86_64/os/repoview/letter_v.group.html](http://download1.rpmfusion.org/free/fedora/releases/26/Everything/x86_64/os/repoview/letter_v.group.html)  
    a) Install VLC and open it and run the sample video provided with VLC.
1) On Fedora what is the command to install via DNF the Dropbox client Located Here: [http://download1.rpmfusion.org/nonfree/fedora/releases/26/Everything/x86_64/os/repoview/letter_d.group.html](http://download1.rpmfusion.org/nonfree/fedora/releases/26/Everything/x86_64/os/repoview/letter_d.group.html)
